...
struct Monstero {
	...
	//int moves1, moves2, moves3, moves4;
...
//};
//
//EffectLayer effect = {"NameOfEffect"};
//
//
//EffectLayer moves[300];
//
//int Love = 0;
//moves[Love] = {};
//
//void Apply(EffectLayer, Monstero);


//EffectLayer moves[50]
...
//outstates.health -= effectLayer[22].power
//EnemyStates.speed -= EffectLayer[22].spd;
//enemyStats.infection = effectLayer[22].infection


//outstates -= float Power = 40;
//outstates -= float Dfs;
//outstates -= float Brutality;
//outstates -= float Spd - 4;
//outstates -= float Heart;
//outstates -= float HP;	int   turns;
//outstates -= bool infection = true;
